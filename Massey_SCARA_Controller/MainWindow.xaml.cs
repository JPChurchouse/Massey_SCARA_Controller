  ...
  public partial class MainWindow : Window
  {
    ...
    private void Ui_SetControlsEnabled(bool enabled = false)
    {
      this.Dispatcher.Invoke(() =>
      {
        ...
        panel_Conv.IsEnabled = enabled ? SERIALPORT_BELT.IsOpen : false;
        ...
        // Special buttons
        btn_Connect.IsEnabled = !Seq_Executing;
        btn_EmergencyStop.IsEnabled = 
          SERIALPORT_SCARA.IsOpen || 
          SERIALPORT_BELT.IsOpen;
